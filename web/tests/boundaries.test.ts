...
describe("import boundaries", () => {
  ...
  it("keeps three.js out of everything that must stay pure", () => {
    const pure = ["view/light.ts", "view/replay.ts", "view/loop.ts", "view/rotation.ts", "view/reaction.ts", "view/cloud.ts", "view/hud.ts", "view/puppet.ts", "view/lips.ts", "view/palette.ts", "view/gait.ts", "view/body.ts", "view/movement.ts", "codec/codec.ts", "honesty/honesty.ts"];
...
describe("banned calls", () => {
  ...
  it("keeps clocks and randomness out of everything between spikes and what the page says about them", () => {
    for (const name of ["view/light.ts", "view/replay.ts", "view/reaction.ts", "view/cloud.ts", "view/hud.ts", "view/puppet.ts", "view/loop.ts", "view/rotation.ts", "view/lips.ts", "view/gait.ts", "view/body.ts", "view/movement.ts", "codec/codec.ts", "honesty/honesty.ts"]) {
